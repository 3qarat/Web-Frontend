  ...
  <footer>
    ...
    <div>
      ...
      <ul class="footer__list">
        ...
        <li><a href="#">مكاتب للإيجار</a></li>
        <li><a href="#">أرض للبيع</a></li>
        <li><a href="#">أرض للإيجار</a></li>
      </ul>
    </div>
    <div>
      <h4>ابق على تواصل دائم معنا</h4>
      <input type="email" placeholder="الإيميل" class="inpt__sec" required />
